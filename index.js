...
client.on("ready", () => {
    ...
    let channel = client.channels.cache.get("1078098474408616029"); // ID DA CATEGORIA DO CANAL DE VOZ
...
👻  | Desenvolvido por`);
    client.user.setActivity(`${config.get(`status`)}`, { type: "STREAMING", url: "https://www.youtube.com/@LilPeepofficial/videos" });
});
